...
<body>
	...
	%>
	<button onclick="array.push(<%=Integer.parseInt(foodname.get(i).getfood_cd())%>)" id ="food<%=i%>" name="food" value=<%=Integer.parseInt(foodname.get(i).getfood_cd())%>><%=foodname.get(i).getfood_name()%></button>
	<%
		}
	%>
	...
	/*20200601 희정 자바코드 자바스크립트로 변환 시작  */
					...
					/* window.onload = function(){
						...
						console.log(food1.value);
						console.log(food2.value);
						
						food1.onclick = function(){
							console.log(food1.value);
							array.push(food1.value);
						}
					food2.onclick = function(){
						console.log(food2.value);
						array.push(food2.value);
					} 
					} */
